          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="flex gap-3">
                <motion.a
                  href="#projects"
                  className="px-6 py-3 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-xl font-semibold text-sm text-black flex items-center gap-2 group relative overflow-hidden"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={(e) => {
                    e.preventDefault();
                ...
                <motion.a
                  href="#contact"
                  className="px-6 py-3 bg-white/5 backdrop-blur-sm border border-yellow-400/30 rounded-xl font-semibold text-sm text-white hover:bg-white/10 transition-colors flex items-center gap-2"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={(e) => {
                    e.preventDefault();
                ...
                <motion.a
                  href="/resume.pdf"
                  download
                  className="px-6 py-3 bg-gradient-to-r from-purple-600/20 to-blue-600/20 border border-purple-400/30 rounded-xl font-semibold text-sm text-white hover:bg-purple-600/30 transition-colors flex items-center gap-2 backdrop-blur-sm"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
              ...
              <div className="flex gap-4 mt-8">
                <motion.a
                  ...
                  className="w-14 h-14 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white transition-all group"
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-blue-400 transition-all group"
                  whileHover={{ scale: 1.1, y: -5 }}
                >
                ...
                <motion.a
                  ...
                  className="w-14 h-14 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-yellow-400 transition-all group"
                  whileHover={{ scale: 1.1, y: -5 }}
                >
